...
## Findings
- **normal**: top avg reward policy = `heuristic` (0.5084).
- **outage**: top avg reward policy = `random` (0.4512).
- **renewable_collapse**: top avg reward policy = `random` (0.4129).
- **shock**: top avg reward policy = `random` (0.4128).
